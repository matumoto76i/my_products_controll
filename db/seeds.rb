...
# 親のパス
lady = Category.create(name: "食品")
men = Category.create(name: "飲料")
baby_kids = Category.create(name: "日用品")
...
# 食品
lady_1 = lady.children.create(name: "生鮮食品")
lady_1.children.create([{name: "果物"},{name: "野菜"},{name: "生鮮魚"},{name: "貝類"},{name: "牛肉"},{name: "豚肉"},{name: "鶏肉"},{name: "混合肉(その他)"},{name: "卵"},{name: "野草"},{name: "その他の生鮮食品"}])
lady_2 = lady.children.create(name: "パン系")
lady_2.children.create([{name: "食パン"},{name: "菓子パン"},{name: "惣菜パン"},{name: "サンドウィッチ"},{name: "バゲット"},{name: "クロワッサン"},{name: "マフィン"},{name: "ナン"},{name: "その他のパン"}])
lady_3 = lady.children.create(name: "調味料")
lady_3.children.create([{name: "塩"},{name: "砂糖"},{name: "酢"},{name: "醤油"},{name: "塩胡椒"},{name: "料理酒"},{name: "みりん"},{name: "一味/七味"},{name: "味噌"},{name: "鶏ガラ"},{name: "味の素"},{name: "その他の調味料"}])
lady_4 = lady.children.create(name: "乳製品(食品)")
lady_4.children.create([{name: "ヨーグルト"},{name: "バター"},{name: "マーガリン"},{name: "チーズ"},{name: "練乳"},{name: "クリーム"},{name: "全粒乳"},{name: "その他の乳製品"}])
lady_5 = lady.children.create(name: "インスタント食品")
lady_5.children.create([{name: "カップ麺"},{name: "袋麺"},{name: "米飯"},{name: "カレー"},{name: "クリームシチュー"},{name: "丼料理の具材"},{name: "煮物"},{name: "増えるワカメ"},{name: "焼きそば"},{name: "うどん"},{name: "味噌汁/吸い物"},{name: "その他のインスタント食品"}])
lady_6 = lady.children.create(name: "缶詰類")
lady_6.children.create([{name: "ツナ缶"},{name: "サバ缶"},{name: "カットフルーツ"},{name: "にしん"},{name: "コーン"},{name: "貝缶"},{name: "その他の缶詰"}])
...
# 飲料
men_1 = men.children.create(name: "水")
men_1.children.create([{name: "軟水"},{name: "硬水"},{name: "炭酸水"},{name: "ポロシャツ"},{name: "タンクトップ"},{name: "ニット/セーター"},{name: "パーカー"},{name: "カーディガン"},{name: "スウェット"},{name: "ジャージ"},{name: "ベスト"},{name: "その他の水"}])
men_2 = men.children.create(name: "清涼飲料")
men_2.children.create([{name: "炭酸飲料"},{name: "果物系ジュース"},{name: "野菜ジュース"},{name: "スポーツドリンク"},{name: "緑茶"},{name: "烏龍茶"},{name: "紅茶"},{name: "ミルクティー"},{name: "コーヒー"},{name: "その他の清涼飲料"}])
men_3 = men.children.create(name: "酒類")
men_3.children.create([{name: "ビール"},{name: "発泡酒"},{name: "酎ハイ"},{name: "芋焼酎"},{name: "麦焼酎"},{name: "日本酒"},{name: "赤ワイン"},{name: "白ワイン"},{name: "ハイボール"},{name: "ウイスキー"},{name: "カクテル"},{name: "その他の酒類"}])
men_4 = men.children.create(name: "乳製品(飲料)")
men_4.children.create([{name: "牛乳"},{name: "豆乳"},{name: "乳酸菌飲料"},{name: "飲むヨーグルト"},{name: "その他の乳製品飲料"}])
